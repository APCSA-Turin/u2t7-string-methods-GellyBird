  ...
  // WRITE AND TEST THE METHODS BELOW
    ...
    */
    public String halvesReversed(String myString) {
        String word1FirstHalf = myString.substring(0, (myString.length()/2));
        String word1SecondHalf = myString.substring((word1FirstHalf.length()));
        String newString = word1SecondHalf + word1FirstHalf;
        return newString;
    }
  }
